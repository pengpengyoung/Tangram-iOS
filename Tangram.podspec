Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  s.source       = { :git => "https://github.com/pengpengyoung/Tangram-iOS.git", :tag => "2.1.5" }
  s.resources    = 'Tangram/Resources/*'
  s.source_files = 'Tangram/**/*.{h,m}'
  
  # s.dependency 'SDWebImage' 
  s.dependency 'LazyScroll', '1.0.1'
  s.dependency 'VirtualView', '1.2.7' :git => "https://github.com/pengpengyoung/VirtualView-iOS.git"
